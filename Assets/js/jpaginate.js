    ...
    $.fn.jPaginate = function(options) {
        ...
        return this.each(function() 
        {
            ...
            function createPagination(curr) {
                ...
                start = "<ul class='"+options.pagination_class+"' id='"+options.basenumerador+"_'>";
                var inicial = "<li><a class='goto_inicial"+options.basenumerador+"' href='#'>"+options.inicial+"</a></li>";
                var previous = "<li><a class='goto_previous"+options.basenumerador+"' href='#'>"+options.previous+"</a></li>";
                var next = "<li><a class='goto_next"+options.basenumerador+"' href='#'>"+options.next+"</a></li>";
                var final = "<li><a class='goto_final"+options.basenumerador+"' href='#'>"+options.final+"</a></li>";
				...
				for (i=1;i<=number_of_pages;i++)
                {
                    if (options.minimize == true) {
                    	...
                    	if (i >= pagi_range.start && i <= pagi_range.end) {
                        	...
                        	else { items += '<li><a href="#" class="goto'+options.basenumerador+'" title="'+i+'">'+i+'</a></li>';}
						} else if (curr <= half) {
            ...
            $(".goto_next"+options.basenumerador).live("click", function(e) {
                e.preventDefault();
                var act = "."+options.active;
                var newcurr = parseInt($("#"+options.basenumerador+"_").find(".active").attr("title")) + 1;
                set_cookie( options.namecookies, newcurr);
				showPage(newcurr);
                $("#"+options.basenumerador+"_").remove();
                createPagination(newcurr);
